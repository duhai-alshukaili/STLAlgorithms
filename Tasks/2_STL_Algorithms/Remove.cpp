...
*       an arbitrary element from a standard container.
*
**************************************************************************************************/
...
static void UnsortedVector(benchmark::State& state)
{
   ...
   {
      state.PauseTiming();
      data.assign( begin(initOrder), end(initOrder) );
      state.ResumeTiming();
...
static void Set(benchmark::State& state)
{
   ...
   {
      state.PauseTiming();
      data.insert( begin(initOrder), end(initOrder) );
      state.ResumeTiming();
